 ...
 * @author kinky
 */
public class ListadoLibros extends javax.swing.JDialog {
    
    
    private ListaLibros todos;

    public ListaLibros getTodos() {
        return todos;
    }

    public void setTodos(ListaLibros todos) {
        this.todos = todos;
    }
     ...
     */
    public ListadoLibros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        todos = Biblioteca.misLibros;
        initComponents();
    }
